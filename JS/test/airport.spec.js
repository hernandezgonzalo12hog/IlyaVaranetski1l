...
describe('Test Suite', () => {
    ...
    let planes = [
        ...
        new EXPERIMENTAL_PLANE("Bell X-14", 277, 482, 500, EXPERIMENTAL_TYPES.HIGH_ALTITUDE, ClassificationLevel.SECRET),
        new EXPERIMENTAL_PLANE("Ryan X-13 Vertijet", 560, 307, 500, EXPERIMENTAL_TYPES.VTOL, ClassificationLevel.TOP_SECRET)
    ];
    ...
    it('Classification is higher for experemental planes then for unclassified', () => {
        ...
        for (let EXPERIMENTAL_PLANE  of bomberMilitaryPlanes) {
            if (EXPERIMENTAL_PLANE.classificationLevel === ClassificationLevel.UNCLASSIFIED) {
